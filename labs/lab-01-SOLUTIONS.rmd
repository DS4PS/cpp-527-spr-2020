...
# if you stayed:
paste0( "OUTCOMES IF YOU STAYED" )
paste0( "GAME SETUP: ", paste0( this.game, collapse=" " ) )
...
paste0( "GAME OUTCOME: ", game.outcome.stay )

# if you switched:
paste0( "OUTCOMES IF YOU SWITCHED" )
paste0( "GAME SETUP: ", paste0( this.game, collapse=" " ) )
paste0( "My initial selection: ", my.initial.pick )
paste0( "The opened goat door: ", opened.goat.door )
paste0( "My final selection: ", my.final.pick.switch )
paste0( "GAME OUTCOME: ", game.outcome.switch )
```
