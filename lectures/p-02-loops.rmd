...
date: '<br> CPP 527 Foundations of Data Science II <br> <br> `r icon::fa("link")` [MS PEDA          ](https://ds4ps.org/ms-prog-eval-data-analytics/courses/)  `r icon::fa("github")` [Source Code](https://github.com/DS4PS/cpp-527-spr-2020/tree/master/lectures)' 
output:
