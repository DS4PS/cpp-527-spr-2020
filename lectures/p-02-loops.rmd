...
date: 'CPP 527 Foundations of Data Science II<br><br>`r icon::fa("link")` [MS PEDA](https://ds4ps.org/ms-prog-eval-data-analytics/courses/)<br>`r icon::fa("github")` [Source Code](https://github.com/DS4PS/cpp-527-spr-2020/tree/master/lectures)'
output:
...
unlike humans, the computer does not get tired, <br>
...
A list should do the trick. After constructing it, you can convert it to a data from with the last line. 

NOTE, assignment to lists uses a double-bracket. 
]
...
Embed your new grame function inside of a loop for 10,000 iterations and collect wins and losses for each strategy. 
